...
class RefugeesLegalServicesController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.refugeesLegalServices.index', compact('refugeesLegalServices'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.refugeesLegalServices.create');
    }
    ...
    public function store(StoreRefugeesLegalServiceRequest $request)
    {
        ...
        return redirect()->route('frontend.refugees-legal-services.index');
    }
    ...
    public function edit(RefugeesLegalService $refugeesLegalService)
    {
        ...
        return view('frontend.refugeesLegalServices.edit', compact('refugeesLegalService'));
    }
    ...
    public function show(RefugeesLegalService $refugeesLegalService)
    {
        ...
        $refugeesLegalService->load('serviceRefugeesLegaRegistrations');

        return view('frontend.refugeesLegalServices.show', compact('refugeesLegalService'));
    }
