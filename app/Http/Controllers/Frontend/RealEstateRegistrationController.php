...
class RealEstateRegistrationController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.realEstateRegistrations.index', compact('realEstateRegistrations'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.realEstateRegistrations.create');
    }
    ...
    public function store(StoreRealEstateRegistrationRequest $request)
    {
        ...
        return redirect()->route('frontend.real-estate-registrations.index');
    }
    ...
    public function edit(RealEstateRegistration $realEstateRegistration)
    {
        ...
        return view('frontend.realEstateRegistrations.edit', compact('realEstateRegistration'));
    }
    ...
    public function show(RealEstateRegistration $realEstateRegistration)
    {
        ...
        return view('frontend.realEstateRegistrations.show', compact('realEstateRegistration'));
    }
