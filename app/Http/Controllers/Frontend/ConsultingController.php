...
class ConsultingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.consultings.index', compact('consultings'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.consultings.create');
    }
    ...
    public function store(StoreConsultingRequest $request)
    {
        ...
        return redirect()->route('frontend.consultings.index');
    }
    ...
    public function edit(Consulting $consulting)
    {
        ...
        return view('frontend.consultings.edit', compact('consulting'));
    }
    ...
    public function show(Consulting $consulting)
    {
        ...
        return view('frontend.consultings.show', compact('consulting'));
    }
