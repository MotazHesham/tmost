...
class UsersController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = User::with(['country', 'roles'])->select(sprintf('%s.*', (new User())->table));
            ...
            $table->rawColumns(['actions', 'placeholder', 'verified', 'country', 'roles']);
    ...
    public function show(User $user)
    {
        ...
        $user->load('country', 'roles', 'userBlogsManagments', 'userCodeForPays', 'userUserAlerts');
