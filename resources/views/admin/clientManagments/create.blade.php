...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.client-managments.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('comany') ? 'is-invalid' : '' }}" type="text" name="comany" id="comany" value="{{ old('comany', '') }}" required>
