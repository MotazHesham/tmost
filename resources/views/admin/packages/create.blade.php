    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.packages.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('books') ? 'is-invalid' : '' }}" name="books[]" id="books" multiple required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('videos') ? 'is-invalid' : '' }}" name="videos[]" id="videos" multiple required>
