...
@can('packages_order_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.packages-orders.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-PackagesOrder">
            <thead>
                <tr>
                    <th width="10">
...
@can('packages_order_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.packages-orders.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.packages-orders.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-PackagesOrder').DataTable(dtOverrideGlobals);
