...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-videosPackages">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($packages as $key => $package)
                        <tr data-entry-id="{{ $package->id }}">
                            ...
                            <td>
                                @foreach($package->books as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-videosPackages:not(.ajaxTable)').DataTable({ buttons: dtButtons })
