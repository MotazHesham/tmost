    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.consulting-bookings.update", [$consultingBooking->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="meeting_link" id="meeting_link" value="{{ old('meeting_link', $consultingBooking->meeting_link) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control datetime" type="text" name="meeting_date" id="meeting_date" value="{{ old('meeting_date', $consultingBooking->meeting_date) }}">
